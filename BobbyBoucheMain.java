// repo: bitcoinj/bitcoinj, branch: release-0.14
// javac BobbyBoucheMain.java -cp *main.ja
// rm -rf BobAppMain/ && time java  -Dbitcoinj.logging=true -cp bitcoinj-bundle-main.jar:.:slf4j-api-1.7.25.jar:slf4j-simple-1.7.25.jar BobbyBoucheMain
...
class BobbyBoucheMain {
    private static Logger logger = LoggerFactory.getLogger(BobbyBoucheMain.class);

    public static void main(String as[]) throws Exception {
        String coin = "BCH";
        NetworkParameters params = MainNetParams.get();
        File dir = new File("BobAppMain");
