// javac BobbyDouche.java -cp bitcoinj-bundle-latest.jar
// rm -rf BobApp/ && java  -Dbitcoinj.logging=true -cp bitcoinj-bundle-latest.jar:.:slf4j-api-1.7.25.jar:slf4j-simple-1.7.25.jar BobbyDouche
...
class BobbyDouche {
    private static Logger logger = LoggerFactory.getLogger(BobbyDouche.class);
    public static void main(String as[]) throws Exception {
        ...
        String coin2 = "BCH";
        NetworkParameters params2 = BCCMainNetParams.get(); //BCCTestNet3Params.get(); //BCCMainNetParams.get();
