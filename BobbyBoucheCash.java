// repo: bitcoinj-cash, branch: cash-0.14
// javac BobbyBoucheCash.java -cp bitcoinj-bundle-cash.jar
// rm -rf BobAppCash/ && java  -Dbitcoinj.logging=true -cp bitcoinj-bundle-cash.jar:.:slf4j-api-1.7.25.jar:slf4j-simple-1.7.25.jar BobbyBoucheCash
...
class BobbyBoucheCash {
    ...
    public static void main(String as[]) throws Exception {
        ...
        File dir2 = new File("BobAppCash2");
